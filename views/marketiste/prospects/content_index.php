<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>
        <i class="fas fa-user-friends me-2"></i>Mes prospects
    </h2>
    <div>
        <a href="/educrm/marketiste/prospects/create" class="btn btn-primary">
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form method="GET" action="/educrm/marketiste/prospects" class="row g-3">
            <div class="col-md-3">
                    ...
                    <?php if (isset($prospects) && count($prospects) > 0): ?>
                        <?php foreach ($prospects as $prospect): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="/educrm/marketiste/prospects/<?php echo $prospect['id']; ?>"
                                           class="btn btn-sm btn-info" title="Voir">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="/educrm/marketiste/prospects/<?php echo $prospect['id']; ?>/edit"
                                    ...
                                    <div class="modal fade" id="statutModal<?php echo $prospect['id']; ?>" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="/educrm/marketiste/prospects/<?php echo $prospect['id']; ?>/change-statut" method="POST">
                        ...
                        <tr>
                            <td colspan="7" class="text-center">
                                <div class="alert alert-info mb-0">
                                    <i class="fas fa-info-circle me-2"></i>Aucun prospect ne vous est affecté pour le moment
                                </div>
                            </td>
                        </tr>
                    <?php endif; ?>
