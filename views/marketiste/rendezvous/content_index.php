<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="/educrm/marketiste/rendezvous/calendar" class="btn btn-info me-2">
            <i class="fas fa-calendar me-2"></i>Calendrier
        </a>
        <a href="/educrm/marketiste/rendezvous/all" class="btn btn-primary me-2">
            <i class="fas fa-list me-2"></i>Tous mes RDV
        </a>
        <a href="/educrm/marketiste/rendezvous/create" class="btn btn-success">
                        ...
                        <?php foreach ($todayList as $rdv): ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <br><small class="text-muted"><?php echo htmlspecialchars($rdv['prospect_telephone'] ?? ""); ?></small>
                                </div>
                                <a href="/educrm/marketiste/rendezvous/<?php echo $rdv['id']; ?>" class="btn btn-sm btn-info">
