<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>
        <i class="fas fa-list me-2"></i>Tous mes rendez-vous
    </h2>
    <div>
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="/educrm/marketiste/rendezvous/all" class="row g-3">
            <div class="col-md-3">
                    ...
                    <?php if (isset($rendezVous) && count($rendezVous) > 0): ?>
                        <?php foreach ($rendezVous as $rdv): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="/educrm/marketiste/rendezvous/<?php echo $rdv['id']; ?>"
                                           class="btn btn-sm btn-info" title="Voir">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="/educrm/marketiste/rendezvous/<?php echo $rdv['id']; ?>/edit"
                                    ...
                                    <div class="modal fade" id="statutModal<?php echo $rdv['id']; ?>" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="/educrm/marketiste/rendezvous/<?php echo $rdv['id']; ?>/change-statut" method="POST">
