<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>
        <i class="fas fa-chart-line me-2"></i>Supervision de mes relances
    </h2>
    <div>
        <a href="/educrm/marketiste/supervision/all" class="btn btn-primary me-2">
            <i class="fas fa-list me-2"></i>Toutes mes relances
        </a>
        <a href="/educrm/marketiste/supervision/create" class="btn btn-success">
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form method="GET" action="/educrm/marketiste/supervision" class="row g-3">
            <div class="col-md-3">
...
<div class="row mb-4">
    <div class="col-md-3">
        <div class="card bg-primary text-white">
            <div class="card-body">
                <h5 class="card-title">Mes relances</h5>
...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card h-100">
            <div class="card-header bg-white">
                <h5 class="mb-0">
                    <i class="fas fa-chart-pie me-2"></i>Répartition de mes relances par type
                </h5>
            </div>
            <div class="card-body">
...
<!-- Mes dernières relances -->
<div class="card">
    <div class="card-header bg-white">
        <h5 class="mb-0">
            <i class="fas fa-clock me-2"></i>Mes dernières relances
        </h5>
    </div>
    <div class="card-body">
                        ...
                        <tr>
                            <td colspan="5" class="text-center">
                                <div class="alert alert-info mb-0">
                                    <i class="fas fa-info-circle me-2"></i>Aucune relance enregistrée
                                </div>
                            </td>
                        </tr>
                    <?php endif; ?>
