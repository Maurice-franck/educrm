<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="/educrm/marketiste/supervision" class="btn btn-secondary me-2">
...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" action="/educrm/marketiste/supervision/all" class="row g-3">
            <div class="col-md-2">
                    ...
                    <?php if (isset($relances) && count($relances) > 0): ?>
                        <?php foreach ($relances as $relance): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/educrm/marketiste/supervision/<?php echo $relance['id']; ?>/edit"
