...
<div class="card">
    <div class="card-body">
        <form action="/educrm/chef-departement/prospects/store" method="POST">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <small class="form-text text-muted">Seules les spécialités de votre département sont proposées.</small>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="alert alert-light border">
                <i class="fas fa-info-circle me-2"></i>Ce prospect vous sera affecté en tant que marketiste référent. Vous pourrez le réaffecter via l'administrateur si besoin.
            </div>
