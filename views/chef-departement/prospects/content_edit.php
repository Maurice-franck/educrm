...
<div class="card">
    <div class="card-body">
        <div class="alert alert-light border mb-3">
            <i class="fas fa-user-tie me-2"></i>Marketiste référent : <strong><?php echo htmlspecialchars($prospect->marketiste_nom ?? 'Non affecté'); ?></strong>
        </div>
        <form action="/educrm/chef-departement/prospects/<?php echo $prospect->id; ?>/update" method="POST">
            <div class="row">
