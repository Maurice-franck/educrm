<div class="mb-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/educrm/rendezvous/<?php echo $rendezVous->id; ?>">Détail</a></li>
...
<div class="card">
    <div class="card-body">
        <form action="/educrm/rendezvous/<?php echo $rendezVous->id; ?>/update" method="POST">

            <!-- Prospect (lecture seule) -->
            <div class="mb-3">
                <label class="form-label">Prospect</label>
                <input type="text" class="form-control"
                       value="<?php echo htmlspecialchars($rendezVous->prospect_nom ?? ''); ?>"
                       readonly disabled>
            </div>
                    ...
                    <?php foreach($marketistes as $mkt): ?>
                        <?php if($mkt['role'] == 'MARKETISTE' || $mkt['role'] == 'ADMIN'): ?>
                            <option value="<?php echo $mkt['id']; ?>"
                                <?php echo $mkt['id'] == $rendezVous->utilisateur_id ? 'selected' : ''; ?>>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control" name="date_rdv"
                           value="<?php echo $rendezVous->date_rdv; ?>" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Heure *</label>
                    <input type="time" class="form-control" name="heure_rdv"
                           value="<?php echo $rendezVous->heure_rdv; ?>" required>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="lieu"
                           value="<?php echo htmlspecialchars($rendezVous->lieu ?? ''); ?>">
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="objet"
                       value="<?php echo htmlspecialchars($rendezVous->objet ?? ''); ?>">
            </div>
            ...
            <div class="mt-4">
                ...
                <a href="/educrm/rendezvous/<?php echo $rendezVous->id; ?>" class="btn btn-secondary">
