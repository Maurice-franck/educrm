...
$langue = $_SESSION['app_langue'] ?? 'fr';
$lang   = require __DIR__ . '/../lang/' . $langue . '.php';
?>
<!DOCTYPE html>
<html lang="fr">
...
<body>
    ...
    <a href="/educrm/dashboard">
        <i class="fas fa-tachometer-alt"></i> <?= $lang['menu_dashboard'] ?>
    </a>
    <a href="/educrm/relances">
        <i class="fas fa-chart-line"></i> <?= $lang['menu_supervision'] ?>
    </a>
    <a href="/educrm/rendezvous">
        <i class="fas fa-calendar-alt"></i> <?= $lang['menu_rendezvous'] ?>
    </a>
    <a href="/educrm/prospects">
        <i class="fas fa-user-friends"></i> <?= $lang['menu_prospects'] ?>
    </a>
    <a href="/educrm/departements">
        <i class="fas fa-building"></i> <?= $lang['menu_departements'] ?>
    </a>
    <a href="/educrm/specialites">
        <i class="fas fa-tags"></i> <?= $lang['menu_specialites'] ?>
    </a>
    <a href="/educrm/sources">
        <i class="fas fa-chart-line"></i> <?= $lang['menu_sources'] ?>
    </a>
    <a href="/educrm/utilisateurs">
        <i class="fas fa-users"></i> <?= $lang['menu_utilisateurs'] ?>
    </a>
    <a href="/educrm/parametres">
        <i class="fas fa-cog"></i> <?= $lang['menu_parametres'] ?>
    </a>

   <button class="btn-dark-mode" onclick="toggleDarkMode()" id="btnDarkMode">
    <i class="fas fa-moon" id="iconDarkMode"></i>
    <span id="labelDarkMode"><?= $lang['menu_mode_sombre'] ?></span>
</button>

<form method="POST" action="/educrm/logout" style="margin: 5px 10px;">
    <button type="submit" class="btn-dark-mode">
        <i class="fas fa-sign-out-alt"></i> <?= $lang['menu_deconnexion'] ?>
    </button>
</form>
</nav>
            </div>
